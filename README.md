...
| Person detection on this computer: YOLOX-nano, fetched on a click, used automatically on the real duck (ADR-0010) | done, real test in M4 |
| „Mit KI entwerfen“: a sentence becomes a draft in the editor, checked against the schema and the building blocks, never saved or run by itself (ADR-0011) | done |
